...
install_xcframework "${PODS_ROOT}/GoNativeCore/GoNativeCore/Frameworks/GoNative.xcframework" "GoNativeCore" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator"
